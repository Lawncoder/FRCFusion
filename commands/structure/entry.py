...
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_Structure'
CMD_NAME = 'Structure Piece'
...
def command_created(args: adsk.core.CommandCreatedEventArgs):
    ...
    try: 
        ...
        typeDropdown = inputs.addDropDownCommandInput('type', "Type", adsk.core.DropDownStyles.TextListDropDownStyle)
        typeDropdown.listItems.add('Rectangular', True)
        typeDropdown.listItems.add('Circular', False)
        ...
        inputs.addValueInput('width', "Width", defaultLengthUnits, adsk.core.ValueInput.createByReal(2.54 ))
...
def command_execute(args: adsk.core.CommandEventArgs):
    ...
    selected_type = type_input.selectedItem.name  # 'Rectangular' or 'Circular'
    ...
    futil.create_tube(width, length, height, comp.xYConstructionPlane, occ, selected_type == 'Circular')
