...
* <<frc-tools-for-fusion,FRC Tools for Fusion>>
* <<installation,Installation>>
* <<sketch-tab-tools,Sketch Tab Tools>>
** <<create-cc-distance,Create C-C Distance Tool>>
** <<edit-cc-distance,Edit C-C Distance Tool>>
** <<bolt-pattern,Bolt Pattern Tool>>
* <<solid-tab-tools,Solid Tab Tools>>
** <<shaft-endings,Shaft Endings Tool>>
** <<timing-belt,Timing Belt Tool>>
* <<timing-pulley,Timing Pulley Tool>>
* <<tubify,Tubify Tool>>
* <<lighten,Lighten Tool>>
* <<shaft-generator,Shaft Generator Tool>>
* <<marker-cad,Marker CAD>>
** <<features,Features>>
...
(Credit goes to 4698 Raider Robotics for the tools in this section except for Shaft Generator)
...
=== Installation
Download the https://github.com/4698RaiderRobotics/FRCTools/releases[latest release^] from GitHub and place in an appopriate folder
...
- **Arm** — Creates a tube attached to a sprocket
- **Belt** — Creates a simple belt
- **Conveyor** — Creates a belt-based conveyor mechanism
- **Drive Train** — Creates a drivetrain (bring your own swerve pod CAD)
- **Elevator** — Creates an elevator
- **Fixed Hooded Shooter** — Creates a shooter with a fixed hood
- **Frame** — Creates either a rectangular or triangular supporting frame
- **Gamepiece** — Creates a generic game piece
- **Rollers** — Creates 1 or 2 horizontal rollers attached to plates
- **Rollers Along a Path** — Creates a series of rollers on a path defined on a face/plane parallel to the XY plane
- **Spindex** — Creates a spindex
- **Structure** — Creates a basic structural piece
- **Telescope** — Creates a telescope
- **Turret** — Creates a turret
- **Variable Shooter** — Creates a shooter with a moving hood
